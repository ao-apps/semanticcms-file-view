...
[![Build](https://github.com/ao-apps/semanticcms-file-view/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/semanticcms-file-view/actions?query=workflow%3ABuild)
