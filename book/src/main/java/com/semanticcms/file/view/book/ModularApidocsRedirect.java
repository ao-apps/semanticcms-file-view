...
package com.semanticcms.file.view.book;
...
@WebServlet("/file/view/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/file/view/apidocs/com.semanticcms.file.view/com" + Objects.toString(req.getPathInfo(), ""),
